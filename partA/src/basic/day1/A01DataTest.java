...
/* 패키지?
 * 인터넷 주소 https://developers.kakao.com/  와 같은 형식에서  developers.kakao.com을 도메인 네임이라고 하며, 
 * 자바의 패키지 이름은 보통 이것을 com.kakao.developers와 같이 높은 단계 부터 표시하여 이름을 정한다.
...
public class A01DataTest {
    ...
    public static void main(String[] args) {
        ...
        //(1) 데이터 저장
        int myage = 19;                       //나이
        double weight = 57.891234567890;     //몸무게
        boolean isAdult;                   //성인 여부
        char grade = 'C';                   //등급

        //(2) 데이터 값 변경 - 대입문 또는 연산자 활용

        //예) 다이어트 한 달 후에 1.3kg 감량된 몸무게
        weight = weight - 1.3;
        // weight -= 1.3;                   //weight = weight - 1.3 수식을 줄여서 쓰는 형식

        //예) 7년 동안 직장 생활을 하면 나이가 몇 살이 되나요?
        myage = myage + 7;
        // age += 7;
...
/*
 * vs code 단축키: 
 *       저장: Ctrl+s, 실행(디버깅 F5): F5, 입력 취소: Ctrl+z
 ...
 *       한 줄씩 실행하며 디버깅하기: 중단점 첫 번째 명령어. -> F5로 시작 -> 계속 F10 눌러서 한 라인씩 확인하기
 */
