...
public class A13ifElseTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("이벤트 기간에 회원 포인트 추가로 적립해 드립니다!!!");
      if(point >=70) {
         System.out.println("Vip 회원이십니다.💕💕");   //이모지 출력: 윈도우 명령창 인코딩을 유니코드 UTF-8로 변경해야 합니다. chcp 65001
         point += 100;
      }else {      //   point < 70 일때 실행
      ...
      // 조건식? 참일 때 실행 명령 또는 값: 거짓일 때 실행하는 명령 또는 값 => 연산 부분이 3가지. 즉, 삼항연산이라고 합니다.
